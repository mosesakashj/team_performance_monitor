...
function QuickAction({ to, title, description, icon }) {
  return (
    ...
    >
      ...
      <svg className="ml-auto h-5 w-5 shrink-0 text-slate-300 transition-colors group-hover:text-brand-500" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
        ...
        <div className="lg:col-span-2">
          ...
          {projectsError ? (
            ...
            <EmptyState
              ...
              description="Once a project's status is set to active, it will show up here."
              icon="📋"
            />
          ) : (
            <div className="grid gap-4 sm:grid-cols-2">
