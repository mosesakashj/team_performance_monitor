export default function ErrorBanner({ message = 'Something went wrong.', onRetry }) {
  return (
    <div className="flex flex-col items-start gap-3 rounded-xl border border-red-200 bg-red-50 px-5 py-4 text-red-800 sm:flex-row sm:items-center sm:justify-between animate-slide-up">
